...
local function init()
  ...
  if Toolbar then
    ...
    uniqueCat:AddItem("Monitor", "GuyWithAMonitor#1595\nWhen placing a cell on a it, it will display that cell on the screen", ids.monitor)
    uniqueCat:AddItem("The Musical Cell", "\"At last, it has come.\" \nIs a trash cell but plays a different pitched sound based off of where the cell entered from.", ids.musical)
    uniqueCat:AddItem("Player Cell", "Can be controlled by the I, J and L keys. You can even control multiple at once!", ids.player)
    --currently only one at a time and controlled with arrow keys
