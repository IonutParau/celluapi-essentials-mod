...
local function init()
  ...
  if Toolbar then
    ...
    --uniqueCat:AddItem("Matter Blob", "Moves forward. When its movement is obstructed by a cell, the blob will turn back to the cell it was before", ids.matterBlob)
